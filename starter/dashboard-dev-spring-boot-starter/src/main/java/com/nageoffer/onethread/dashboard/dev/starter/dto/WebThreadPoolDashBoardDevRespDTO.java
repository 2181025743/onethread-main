...
package com.nageoffer.onethread.dashboard.dev.starter.dto;
...
public class WebThreadPoolDashBoardDevRespDTO {
    ...
    /**
     * 执行拒绝策略次数
     * 为保障 Web 线程池详情页面和动态线程池页面一致，默认-1
     */
    private Long rejectCount = -1L;
